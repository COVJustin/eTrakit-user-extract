...
import threading
import publicscrapper

def long_operation_thread(usr, pwd, window):
    publicscrapper.login('https://vall-trk.aspgov.com/eTRAKiT_Admin/EtrakitUserList.aspx?lt=PUBLIC_REGISTERED', publicscrapper.driver_setup(), usr, pwd)
